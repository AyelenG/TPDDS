...
public class EvaluadorTest {	
	...
	public void inicio() {
		...
		Repositorios.indicadoresPredefinidos.agregarIndicador(indicador);
	}
	...
	public void evaluacionConIndicadorEnFormula(){
		assertEquals(20, Evaluador.evaluar(new Indicador("1","<PODER> + 5"), periodo).doubleValue(), 0);
	}
	...
	public void nullSiDividePor0(){
		assertNull(Evaluador.evaluar(new Indicador("7","5/0"), null));
	}
